...
# Changes have been made to move all template parameters to the top of the script for easier editing.
# Additionally this version functions with plain Virual Machines vs. a VM Scale Set
#
# THIS IS SKUNKWORKS - many of the variables supported by that template have been hardcoded here
#
# USE AT YOUR OWN RISK

set -euo pipefail

VAULT_TLS_CERT_KEYVAULT_SECRET_ID="${vault_tls_cert_keyvault_secret_id}"
VAULT_TLS_PRIVKEY_KEYVAULT_SECRET_ID="${vault_tls_privkey_keyvault_secret_id}"
VAULT_TLS_CA_BUNDLE_KEYVAULT_SECRET_ID="NONE"
VAULT_LICENSE_KEYVAULT_SECRET_ID="${vault_license_keyvault_secret_id}"
VM_DOMAIN_SUFFIX="${vm_domain_suffix}"
AUTO_JOIN_CLUSTER_TAG_KEY="VaultCluster"
AUTO_JOIN_CLUSTER_TAG_VALUE="${friendly_name_prefix}"
VAULT_LEADER_TLS_SERVERNAME="${vault_leader_tls_servername}"
VAULT_SEAL_AZUREKEYVAULT_VAULT_NAME="${vault_seal_azurekeyvault_vault_name}"
VAULT_SEAL_AZUREKEYVAULT_UNSEAL_KEY_NAME="${vault_seal_azurekeyvault_unseal_key_name}"
